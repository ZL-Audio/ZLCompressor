    ...
    public:
        DraggerAttachment(dragger::Dragger &dragger, juce::AudioProcessorValueTreeState &apvts,
            ...
            : dragger_(dragger), apvts_(apvts),
              ...
              normalisable_range_x_(std::move(normalisable_range_x)),
              normalisable_range_y_(std::move(normalisable_range_y)),
        ...
        void updateComponent() override {
            ...
            if (dragger_.getXPortion() != new_x || dragger_.getYPortion() != new_y) {
    ...
    private:
        ...
        void draggerValueChanged(dragger::Dragger *) override {
            parameter_x_ref_.setValueNotifyingHost(
                normalisable_range_x_.convertTo0to1(dragger_.getXPortion()));
            parameter_y_ref_.setValueNotifyingHost(
                normalisable_range_y_.convertTo0to1(dragger_.getYPortion()));
        }
    };
}

...
namespace zlgui {
    ...
    void UIBase::loadFromAPVTS() {
        ...
        wheel_sensitivity_[4] = state.getRawParameterValue(zlstate::PDraggerSensitivity::kID)->load();
        wheel_sensitivity_[5] = state.getRawParameterValue(zlstate::PDraggerFineSensitivity::kID)->load();
